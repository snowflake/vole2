// This file is automatically generated by generic_table.awk.
//               *** Do Not Edit ***
// #
// #    Name:     Vole internal character set to CP1252 extended table
// #    General notes: none
// #
// #    Format: Three tab-separated columns
// #        Column #1 is the Vole code (in hex)
// #        Column #2 is the CP1252 (in hex as 0xXXXX)
...
//   out         in  comment
    ...
    0x0081, // 0x1A #SUBSTITUTE        reassigned
    0x001B, // 0x1B #ESCAPE
    0x008d, // 0x1C #FILE SEPARATOR    reassigned
    0x008f, // 0x1D #GROUP SEPARATOR   reassigned
    0x0090, // 0x1E #RECORD SEPARATOR  reassigned
    0x009D, // 0x1F #UNIT SEPARATOR    reassigned
    0x0020, // 0x20 #SPACE
    ...
    0x007E, // 0x7E #TILDE
    0x007F, // 0x7F #DELETE
    0x0080, // 0x80 #EURO SIGN
    0x0081, // 0x81 #UNDEFINED should never appear
    0x0082, // 0x82 #SINGLE LOW-9 QUOTATION MARK
    0x0083, // 0x83 #LATIN SMALL LETTER F WITH HOOK
    0x0084, // 0x84 #DOUBLE LOW-9 QUOTATION MARK
    0x0085, // 0x85 #HORIZONTAL ELLIPSIS
    0x0086, // 0x86 #DAGGER
    0x0087, // 0x87 #DOUBLE DAGGER
    0x0088, // 0x88 #MODIFIER LETTER CIRCUMFLEX ACCENT
    0x0089, // 0x89 #PER MILLE SIGN
    0x008a, // 0x8A #LATIN CAPITAL LETTER S WITH CARON
    0x008b, // 0x8B #SINGLE LEFT-POINTING ANGLE QUOTATION MARK
    0x008c, // 0x8C #LATIN CAPITAL LIGATURE OE
    0x008d, // 0x8D #UNDEFINED should never appear
    0x008e, // 0x8E #LATIN CAPITAL LETTER Z WITH CARON
    0x008f, // 0x8F #UNDEFINED should never appear
    0x0090, // 0x90 #UNDEFINED should never appear
    0x0091, // 0x91 #LEFT SINGLE QUOTATION MARK
    0x0092, // 0x92 #RIGHT SINGLE QUOTATION MARK
    0x0093, // 0x93 #LEFT DOUBLE QUOTATION MARK
    0x0094, // 0x94 #RIGHT DOUBLE QUOTATION MARK
    0x0095, // 0x95 #BULLET
    0x0096, // 0x96 #EN DASH
    0x0097, // 0x97 #EM DASH
    0x0098, // 0x98 #SMALL TILDE
    0x0099, // 0x99 #TRADE MARK SIGN
    0x009a, // 0x9A #LATIN SMALL LETTER S WITH CARON
    0x009b, // 0x9B #SINGLE RIGHT-POINTING ANGLE QUOTATION MARK
    0x009c, // 0x9C #LATIN SMALL LIGATURE OE
    0x009d, // 0x9D #UNDEFINED      should never appear
    0x009e, // 0x9E #LATIN SMALL LETTER Z WITH CARON
    0x009f, // 0x9F #LATIN CAPITAL LETTER Y WITH DIAERESIS
